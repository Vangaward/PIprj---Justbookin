...
<div class="image-container">
    <div class="banner-wrapper">
        <img class="Banner" src="<?php echo $dadosUsuario['banner']; ?>" alt="Banner do Perfil">
    </div>
</div>
<div class="usuario">
	<div class="infoUsuario">
		...
		<div class="nomeStats">
			...
			<div style="display: flex; align-items: center; gap: 5px; color: var(--verde)">
				<?php if ($dadosUsuario['tipoConta'] == 2) { ?>
					<span style="--corSVG: var(--verde); display: flex; width: 20px; height: 20px"><?php include('icones/LiteraturaVerificada.svg'); ?></span>
					<b>Editora verificada</b>
				<? } ?>
			</div>
			<div class="statsUser">
	...
	<div class="botoesUsuario">
		...
		<?php if ($meuUsuario){ ?>
			<div class="dropdown">
				<button class="btnConfig" onclick="openDropdownConfig()" style="--corSVG: var(--cor4Escuro)"><?php include('icones/configuracoes.svg'); ?></button>
				<div class="dropdownOpcoes" id="idDropdownOpcoes">
					<button class="btnOpcao" onclick="openPopupImgPerfilEdit()">Alterar Foto de Perfil</button>
					<button class="btnOpcao" onclick="openPopupBannerEdit()">Alterar Banner</button>
					<button class="btnOpcao" onclick="location.href='alterarSenha.php'">Alterar Senha</button>
				</div>
			</div>
		<?php } ?>
	</div>
...
<div class="conteudo">
	...
	<div class="dropdown">
		<button class="filtro" onclick="toggleDropdown()" style="--corSVG: var(--branco)"><?php include_once('icones/classificador.svg'); ?></button>
