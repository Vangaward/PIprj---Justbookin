					...
					<div class="divForm">
						<form class="form" name="frmLogin" id="frmLogin" action="" method="post">
							...
							<div class="divLogin">
								...
								<input class="txtCampo" type="text" placeholder="Exemplo@gmail.com" name="email" id="Email">
								<div class="gapErro"></div>
								<label class="lblCampo">Senha:</label>
								<input class="txtCampo" type="password" placeholder="••••••••" name="senha" id="senhaid">
								<div class="gapErro"></div>
...
<div class="back">
	<div id="b2" class="back-content">
		<!--Esqueci a senha-->
		<div class="divForm">
			<form class="form" name="frmRe" action="" method="post">
			<h1 class="titulo">Redefinir senha</h1>
			<div class="divLogin">
				<label class="lblCampo">Insira o seu E-mail:</label>
				<input class="txtCampo" placeholder="Exemplo@gmail.com" type="text" name="emailRedefineSenha" id="Email">
				<div class="gapErro"></div>
				<div class="container">
					<input class="btnCadastrar" type="button" value="Voltar" id="cadastrar" name="btnCadastrar" onclick="goLogin()">
...
//Script para ajudar na responsividade da telaLoginErro
