...
!-->
  <center>
	<div class="livro">
	<button class="btnVoltar" onclick="window.location.href='livro.php?i=<?php echo $idLitSha1; ?>'">Voltar à página do livro</button><br>
	<?php if ($temCaps == 1){?>
	<button class="btnAnt" onclick="window.location.href='<?php echo $linkBtnCapAnt; ?>'">Capítulo anterior</button>
	<button class="btnPro" onclick="window.location.href='<?php echo $linkBtnCapProx; ?>'">Próximo capítulo</button>
    <?php } ?>
