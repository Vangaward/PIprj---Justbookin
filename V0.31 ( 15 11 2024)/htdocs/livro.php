...
<html lang="pt-br">
	...
	<body>
		...
		if (!$litExiste)
		{?>
			<p>A literatura não foi encontrada</p>
		<?
		}
			...
			<div class="containerLivro">
				...
				<div class="opcoesLivro">
					...
					<? foreach ($dadosVerif as $verificacao) { ?>
							<a href="perfil?i=<? echo $verificacao['idUsuarioCripto']; ?>"><label class="lblVerificacoes"><?include('icones/LiteraturaVerificada.svg');?> <? echo $verificacao['nomeUsuario'];?></label><label class="lblDataVerificaco"><? echo $verificacao['data']; ?></label></a>
					<? } ?>
						</div>
					<? } ?>
