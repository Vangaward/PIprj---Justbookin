...
function selectLits($idUsuarioSha1, $lad, $meuUsuario)
{
    ...
    SELECT l.idLit, l.titulo, l.urlCapa, l.status, u.idUsuario, u.nomeUsuario, u.nome,
    ...
    WHERE sha1(l.idUsuario) = '$idUsuarioSha1'
    GROUP BY l.idLit, l.titulo, l.urlCapa, l.status, u.idUsuario, u.nomeUsuario, u.nome
    ORDER BY l.idLit $lad;
	");
