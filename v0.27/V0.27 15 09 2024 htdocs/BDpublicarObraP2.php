...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	/*Inserir literatura*/
		$sqlinsertLit = "INSERT INTO Literatura (dataEdit, urlCapa, dataLanc, idUsuario, titulo, descricao, views, status, urlPdf) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
		...
		$views = 0;
		$status = 0;
		mysqli_stmt_bind_param($stmt, 'sssssssss', $dataHoraAtual, $nomeArquivoUnicoCapa, $dataHoraAtual, $idUsuario, $titulo, $descricao, $views, $status, $nomeArquivoUnicoPDF);
