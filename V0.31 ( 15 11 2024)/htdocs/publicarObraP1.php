...
<body>
    ...
    <main class="conteudo">
        <?php
        if ($msgErro != null) { ?>
		<div class='alert alert-danger' role='alert' style='animation-name: Rotacao3d; animation-duration: 1s;'><center><?php echo $msgErro; ?></center></div>
        <?php } ?>

        <label class="tituloPagina">PUBLICAR OBRA</label>
        <form method="POST" action="publicarObraP2" id="frmPublicarId" enctype="multipart/form-data">
            <div class="etapas">
