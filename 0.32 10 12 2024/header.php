            ...
            <div class="btns">
				<?php if ($logado == 1) { ?>
					<!-- Conteúdo relacionado ao usuário logado, se necessário -->
						<button class="btnPub" onclick="location.href='publicarObraP1.php'"><?php include('imagens/Livro.svg'); ?><label class="lblPub">Publicar obra</label></button>
    ...
    <div class="container">
        ...
        <div class="sidebar" id="sidebar">
            <ul>
				...
				<li class="li1"><a href="historico" class="btnFav" style="color: var(--cor4Escuro);">Histórico</a></li>
				...
				<?php if ($dadosLogin['tipoConta'] == 1) { ?>
				<li class="li1"><a href="adm/painelControle" class="btnPainelControl" style="color: var(--cor4Escuro);">Painel de controle (ADM)</a>  
				<?php } ?>
				<?php
